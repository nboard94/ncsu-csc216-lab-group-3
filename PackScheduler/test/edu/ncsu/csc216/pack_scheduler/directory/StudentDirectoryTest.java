...
public class StudentDirectoryTest {
	...
	public void testLoadStudentsFromFile() {
		...
		try {
			sd.loadStudentsFromFile(invalidFile);
		...
		try {
			sd.loadStudentsFromFile(notFile);
		} catch (IllegalArgumentException e) {
	...
	public void testAddStudent() {
		...
		assertTrue(sd.addStudent(FIRST_NAME, LAST_NAME, "other_id", EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
		...
		try {
			sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "pw", "pww", MAX_CREDITS);
		} catch (IllegalArgumentException e) {
			assertEquals("Passwords do not match", e.getMessage());
		}
		try {
			sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "pw", null, MAX_CREDITS);
		} catch (IllegalArgumentException e) {
			assertEquals("Invalid password", e.getMessage());
		}
		try {
			sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, "", "pw", MAX_CREDITS);
		} catch (IllegalArgumentException e) {
			assertEquals("Invalid password", e.getMessage());
		}
		try {
	...
	public void testSaveStudentDirectory() {
		...
		try {
			sd.saveStudentDirectory(invalidPath);
		} catch (IllegalArgumentException e) {

...
public class CourseTest {
	...
	public void testSetSection() {
		...
		//Test that setting the section to non-digit string.
		try {
			c.setSection("abc");
			fail();
		} catch (IllegalArgumentException e) {
	...
	public void testCompareTo() {
		Course c1 = new Course("CSC116", "Java", "001", 3, "kgohel2", 50, "MWF");
		Course c2 = new Course("CSC116", "Java", "002", 3, "kgohel2", 50, "MWF");
		Course c3 = new Course("CSC216", "Java 2", "001", 3, "kgohel2", 50, "MWF");
		Course c4 = new Course("CSC316", "Java 3", "003", 4, "kgohel2", 50, "MWF");
		Course c5 = new Course("CSC116", "Java", "001", 3, "kgohel2", 50, "MWF");
		...
		assertEquals(0, c5.compareTo(c1));
		...
		assertEquals(-1, c5.compareTo(c3));
	...
	/**
	 * Tests the getLongDisplayArray() method of Course.
	 */
	@Test
	public void testGetLongdisplayArray() {
		Course c1 = new Course("CSC116", "Java", "001", 3, "kgohel2", 50, "MWF", 1330, 1440);
		String[] s = c1.getLongDisplayArray();
		assertEquals("CSC116", s[0]);
		assertEquals("001", s[1]);
		assertEquals("Java", s[2]);
		assertEquals("3", s[3]);
		assertEquals("kgohel2", s[4]);
		assertEquals("MWF 1:30PM-2:40PM", s[5]);
		assertEquals("", s[6]);
	}

	/**
	 * Tests the getShortDisplayArray() method of Course.
	 */
	@Test
	public void testGetShortdisplayArray() {
		...
		assertEquals("001", s[1]);
		assertEquals("Java", s[2]);
		assertEquals("MWF 1:30PM-2:40PM", s[3]);
	}
	
	/**
	 * Tests the isDuplicated() method of Course.
	 */
	@Test
	public void testIsDuplicated() {
		Course c1 = new Course("CSC116", "Java", "001", 3, "kgohel2", 50, "MWF", 1330, 1440);
		Course c2 = new Course("CSC216", "Java", "001", 3, "kgohel2", 50, "MWF", 1330, 1440);
		Course c3 = new Course("CSC116", "Javacoco", "001", 3, "kgohel2", 50, "MWF", 1330, 1440);
		Course c4 = new Course("CSC116", "Java", "002", 3, "kgohel2", 50, "MWF", 1330, 1440);
		Course c5 = new Course("CSC116", "Java", "001", 4, "kgohel2", 50, "MWF", 1330, 1440);
		Course c6 = new Course("CSC116", "Java", "001", 3, "kgohel12", 50, "MWF", 1330, 1440);
		Course c7 = new Course("CSC116", "Java", "001", 3, "kgohel2", 50, "MF", 1330, 1440);
		Course c8 = new Course("CSC116", "Java", "001", 3, "kgohel2", 50, "MWF", 1300, 1440);
		Course c9 = new Course("CSC116", "Java", "001", 3, "kgohel2", 50, "MWF", 1330, 1400);
		Course c10 = null;
		...
		assertFalse(c1.isDuplicate(c5));
		assertFalse(c1.isDuplicate(c6));
		assertFalse(c1.isDuplicate(c7));
		assertFalse(c1.isDuplicate(c8));
		assertFalse(c1.isDuplicate(c9));
